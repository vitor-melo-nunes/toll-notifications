...
public class CustomerResponseBody {
    ...
    public CustomerResponseBody(String licensePlateNumber, String identificationDocument, String name, String phone, Instant createdAt) {
    ...
    public Customer convertToDomain() {
        ...
        customer.setLicensePlateNumber(this.licensePlateNumber);
        customer.setIdentificationDocument(this.identificationDocument);
